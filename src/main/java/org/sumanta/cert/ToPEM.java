...
public class ToPEM {
    ...
    public void toPEM(final X509Certificate x509Certificate, final String name) throws IOException, CertificateParsingException {
    ...
    public OutputStream toPEM(final X509Certificate x509Certificate) throws IOException, CertificateParsingException, CertificateEncodingException {
