...
public class KeypairGenerator {
  ...
  public KeyPair generateRSAKeyPair(String signatureAlgo, int keysize) throws NoSuchProviderException,
   ...
   */
  @Deprecated
  public KeyPair generateKeyPairAndSaveToFile(String filename) throws NoSuchProviderException,
